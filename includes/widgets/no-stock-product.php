...
class Dokan_No_Stock_Product_Widget extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 'classname' => 'woocommerce widget_products dokan-no-stock-product', 'description' => 'A Widget for displaying Saled Products for dokan' );
        parent::__construct( 'dokan-no-stock-widget', 'Dokan: Saled Product Widget', $widget_ops );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $r = dokan_get_no_stock_products( $no_of_product );
...
} // class Dokan no stock product widget

add_action( 'widgets_init', create_function( '', "register_widget( 'Dokan_No_Stock_Product_Widget' );" ) );